...
> 
> I am an active community contributor too, where I try to assist developers resolving their development challenges. My [Stackoverflow](https://stackoverflow.com/users/9663070/md-farid-uddin-kiron) contains over `800+` detailed solution of various programming problems (linked to Github Repositories) around Microsoft Technologies that brings me around `850+K` readers.
